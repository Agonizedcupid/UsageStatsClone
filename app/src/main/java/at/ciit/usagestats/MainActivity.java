...
public class MainActivity extends AppCompatActivity {
    ...
    private Button dailyBtn, sevenDaysBtn, monthBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sevenDaysBtn = findViewById(R.id.sevenDaysBtn);
        monthBtn = findViewById(R.id.monthBtn);

        dailyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadStatistics(4, startTime(4), endTime(4));
            }
        });
        ...
        sevenDaysBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadStatistics(1, startTime(1), endTime(1));
            }
        });
        ...
        monthBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadStatistics(2, startTime(2), endTime(2));
            }
        });
    ...
    protected void onStart() {
        ...
        if (getGrantStatus()) {
            ...
            showBtn.setOnClickListener(view -> loadStatistics(1, startTime(4), endTime(4)));
        } else {
    ...
    public long startTime(int type) {
    ...
    public long endTime(int type) {
        if (type == 4) {
            return startTime(type) + 86400 * 1000;
        }
        if (type == 1) {
            return startTime(type) + (86400 * 7 * 1000);
        }
        if (type == 2) {
            return startTime(type) + (86400L * 30 * 1000);
        }
        return 0L;
    }
     ...
     */
    public void loadStatistics(int type, long beginTime, long endTime) {
//        Calendar calendar = Calendar.getInstance();
//        calendar.set(Calendar.HOUR_OF_DAY, 0);
//        calendar.set(Calendar.MINUTE, 0);
//        calendar.set(Calendar.SECOND, 0);
...
//        long endTime = beginTime + 86400 * 1000;
        //cal.add(Calendar.DAY_OF_YEAR, -24);
        //Toast.makeText(this, ""+Calendar.DAY_OF_YEAR, Toast.LENGTH_SHORT).show();
        UsageStatsManager usm = (UsageStatsManager) this.getSystemService(USAGE_STATS_SERVICE);
        List<UsageStats> appList = usm.queryUsageStats(type,
                beginTime, endTime);
